...
const Diamonds = () => {
  ...
  useEffect(() => {
    ...
    diamondGeo.easy === true && diamondGeo.medium === true && diamondGeo.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondGeo({ easy: false, medium: false, hard: false })
  ...
  useEffect(() => {
    ...
    diamondArts.easy === true && diamondArts.medium === true && diamondArts.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondArts({ easy: false, medium: false, hard: false })
  ...
  useEffect(() => {
    ...
    diamondSport.easy === true && diamondSport.medium === true && diamondSport.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondSport({ easy: false, medium: false, hard: false })

  }, [diamondSport])


  useEffect(() => {
    diamondFood.easy === true && diamondFood.medium === true && diamondFood.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondFood({ easy: false, medium: false, hard: false })
  ...
  useEffect(() => {
    ...
    diamondFilm.easy === true && diamondFilm.medium === true && diamondFilm.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondFilm({ easy: false, medium: false, hard: false })
  ...
  useEffect(() => {
    ...
    diamondGen.easy === true && diamondGen.medium === true && diamondGen.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondGen({ easy: false, medium: false, hard: false })
  ...
  useEffect(() => {
    ...
    diamondMus.easy === true && diamondMus.medium === true && diamondMus.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondMus({ easy: false, medium: false, hard: false })
  ...
  useEffect(() => {
    ...
    diamondHist.easy === true && diamondHist.medium === true && diamondHist.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondHist({ easy: false, medium: false, hard: false })

  }, [diamondHist])

  useEffect(() => {

    diamondSci.easy === true && diamondSci.medium === true && diamondSci.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondSci({ easy: false, medium: false, hard: false })

  }, [diamondSci])

  useEffect(() => {
    diamondSoc.easy === true && diamondSoc.medium === true && diamondSoc.hard === true && setDiamonds(prev => (prev + 1)) && setDiamondSoc({ easy: false, medium: false, hard: false })
  }, [diamondSoc])
...
setDiamondPoints(0)  
	...
	useEffect(() => {
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "Arts & Literature" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "General Knowledge" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "Food & Drink" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "Film & TV" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "Music" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "Society & Culture" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "Sport & Leisure" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "Science" && diff === "medium" &&
		...
		selected === rightAnswer[indexCounter] && results[indexCounter].category === "History" && diff === "medium" &&
...
useEffect(()=>{
  ...
  return (
    <div >
      ...
      {diamondGeo.easy === true && diamondGeo.medium === true && diamondGeo.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_geography" />}
      {diamondArts.easy === true && diamondArts.medium === true && diamondArts.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_art" />}
      {diamondSport.easy === true && diamondSport.medium === true && diamondSport.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_sports" />}
      {diamondFood.easy === true && diamondFood.medium === true && diamondFood.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_food" />}
      {diamondFilm.easy === true && diamondFilm.medium === true && diamondFilm.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_film" />}
      {diamondGen.easy === true && diamondGen.medium === true && diamondGen.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_gen" />}
      {diamondMus.easy === true && diamondMus.medium === true && diamondMus.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_music" />}
      {diamondHist.easy === true && diamondHist.medium === true && diamondHist.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_history" />}
      {diamondSci.easy === true && diamondSci.medium === true && diamondSci.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_science" />}
      {diamondSoc.easy === true && diamondSoc.medium === true && diamondSoc.hard === true && <img className="diamondArt" src={diamondArt} alt="Diamond_social" />}
