...
const Correct = () => {
    ...
    useEffect(() => {
        ...
        (streak === 3 && img && next) && setMessageStreak("3 CORRECT IN A ROW + 20 POINtS + 1 hint !!!");
        (streak === 4 && img && next) && setMessageStreak("4 CORRECT IN A ROW + 30 POINtS + 1 hint !!!");
        (streak === 5 && img && next) && setMessageStreak("5 CORRECT IN A ROW + 50 POINtS + 1 hint !!!");
        (streak === 6 && img && next) && setMessageStreak("6 CORRECT IN A ROW + 100 POINtS + 1 hint !!!");
