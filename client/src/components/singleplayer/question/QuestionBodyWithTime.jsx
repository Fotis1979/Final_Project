...
const QuestionBody = () => {
	...
	useEffect(() => {
		questionCount === 0 && setCircleGeo(false);
		questionCount === 0 && setCircleGeo2(false);
		questionCount === 0 && setCircleFood(false);
		questionCount === 0 && setCircleFood2(false);
		questionCount === 0 && setCircleGen(false);
		questionCount === 0 && setCircleGen2(false);
		questionCount === 0 && setCircleFilm(false);
		questionCount === 0 && setCircleFilm2(false);
		questionCount === 0 && setCircleSport(false);
		questionCount === 0 && setCircleSport2(false);
		questionCount === 0 && setCircleSoc(false);
		questionCount === 0 && setCircleSoc2(false);
		questionCount === 0 && setCircleSci(false);
		questionCount === 0 && setCircleSci2(false);
		questionCount === 0 && setCircleMus(false);
		questionCount === 0 && setCircleMus2(false);
		questionCount === 0 && setCircleHist(false);
		questionCount === 0 && setCircleHist2(false);
	}, [
		questionCount,
		setCircleArts,
		setCircleArts2,
	...
	useEffect(() => {
		questionCount === 0 && setCircleArts(false);
		questionCount === 0 && setCircleArts2(false);
	...
	return (
		<>
			...
			<div className='qa--section'>
				...
				{!img && gameOver !== true && (
					<button className='rewards--btn leave--btn' onClick={tr}>
						LEAVE GAME
					</button>
				)}
					...
					{gameOver === false && (
						...
						>
							...
							{gameOver === false && timeUp === true && (
								<div className='cat timeup'>TIME UP !!! CLICK NEXT</div>
							)}
						</div>
					)}
								...
								<div className='cat4'>
									<ul>
										<li value={e} className={cat === e ? 'cat5' : 'cat6'}>
											{e}
											{circleGeo === true && e === 'geography' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleGeo2 === true && e === 'geography' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleArts === true && e === 'arts' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleArts2 === true && e === 'arts' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleGen === true && e === 'general' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleGen2 === true && e === 'general' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleFood === true && e === 'food' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleFood2 === true && e === 'food' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleFilm === true && e === 'film' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleFilm2 === true && e === 'film' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleSci === true && e === 'science' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleSci2 === true && e === 'science' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleSoc === true && e === 'society' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleSoc2 === true && e === 'society' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleHist === true && e === 'history' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleHist2 === true && e === 'history' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleSport === true && e === 'sport' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleSport2 === true && e === 'sport' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
											{circleMus === true && e === 'music' ? (
												<img className='diamondArt2' src={green} alt='' />
											) : (
												''
											)}
											{circleMus2 === true && e === 'music' ? (
												<img className='diamondArt3' src={green} alt='' />
											) : (
												''
											)}
