...
const Settings = () => {
    ...
    const {
        incorrect, setIncorrect, allAnswers, setAllAnswers,questions, setQuestions,correctAnswer, setCorrectAnswer,diff,setDiff,cat,setCat
    } = context;
  ...
  const x = (e) => {
    ...
    return (
     ...
     { d &&     <select onChange={e => x(e)}>
       <option onChange={e => x(e)} value = "Arts & Literature">Arts & Literature</option>
       <option onChange={e => x(e)} value= "Film & TV">Film & TV</option>
       <option onChange={e => x(e)} value = "Food & Drink">Food & Drink</option>
       ...
       <option onChange={e => f(e)} value = "Society & Culture">Society & Culture </option>
       <option onChange={e => f(e)} value = "Sport & Leisure">Sport & Leisure </option>
