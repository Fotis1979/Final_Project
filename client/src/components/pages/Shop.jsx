...
const Shop = () => {
	...
	return (
		<>
			...
			<h2 className='diamonds-shop'> diamonds :{diamonds}</h2>
			<div className='avatar-shop'>
				<div>
					<img src={q} alt='' width='100px' /> <p>5 diamonds</p>{' '}
				...
				<div>
					<img src={q} alt='' width='100px' /> <p>10 diamonds</p>
				...
				<div>
					<img src={q} alt='' width='100px' /> <p>15 diamonds</p>
				...
				<div>
					<img src={q} alt='' width='100px' /> <p>20 diamonds</p>
				...
				<div>
					<img src={q} alt='' width='100px' /> <p>25 diamonds</p>
